...
//share video
document.addEventListener("DOMContentLoaded", function () {
  let linkedinBtn = document.querySelector(".linkedin-share");
  ...
  linkedinBtn.href = `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(
    videoUrl
  )}&title=${shareText}`;
  twitterBtn.href = `https://twitter.com/intent/tweet?text=${shareText}&url=${encodeURIComponent(
    videoUrl
  )}`;
